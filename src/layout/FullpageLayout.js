        ...
        <Box className={classes.root}>
            <AppBar position="static" className={classes.appbar}>
                <Toolbar className={classes.toolbar}>
                    ...
                    <Box className={classes.topTabList}>
                        <AppBar position="static" className={classes.topTabRight}>
                            <Tabs value={value} onChange={handleChange} aria-label="simple tabs example">
                                <Tab label="Wallet" {...a11yProps(0)} />
                                <Tab label="Exchange" {...a11yProps(1)} />
                                <Tab label="Explorer" {...a11yProps(2)} />
                            </Tabs>
                        </AppBar>
            ...
            <Box style = {{ backgroundImage: `url(${Background})`,  backgroundSize: "100% 100%" }}>
                {children}
            </Box>
        </Box>
    );
